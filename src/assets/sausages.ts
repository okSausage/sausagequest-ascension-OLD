function mouseDirection() {
  ...
  script.innerText =
    '$(document).mousemove(function (e) {$("#sausage").css({left: e.pageX, bottom: (Math.random() * window.screen.availHeight) / 25; })});-moz-transform:scale(1, 1);-webkit-transform:scale(1, 1);-o-transform:scale(1, 1);filter: FlipH;';
